...
class TicketNode:
    def __init__(self, kode, nama, konser, seat, kategori, jumlah, total):
        self.kode = kode
        self.nama = nama
        self.konser = konser
        self.seat = seat
...
class TicketLinkedList:
    ...
    def tambah_tiket(self, kode, nama, konser, seat, kategori, jumlah, total):
        node = TicketNode(kode, nama, konser, seat, kategori, jumlah, total)
        if not self.head:
            self.head = node
        else:
            cur = self.head
    ...
    def update_tiket(self, kode, nama, seat, kategori, jumlah, total):
        cur = self.head
        while cur:
            if cur.kode == kode:
                cur.nama = nama
...
if submit and nama:
    ...
    st.session_state.tickets.tambah_tiket(
        kode, nama, konser, seat, kategori, jumlah, total
    )
